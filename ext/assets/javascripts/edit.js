      ...
      return $("#trello-card-submit").on("click", function() {
        return validate_card_info(function(validated) {
          if (validated) {
            ...
            var appendedStrings = "Account Type: " + $("#trello-card-description").val() + "\n\n" +
                                  "What Happened: " + $("#trello-card-whathappened").val() + "\n\n" + 
                                  "Expected Behaviour: " + $("#trello-card-expectedbehavior").val() + "\n\n";
            return submit_trello_card(access, $("#trello-card-name").val(), appendedStrings + page_info, $("#trello-lists select option:selected").val(), $("#trello-card-picker").find(".selected").data("card-id"), get_selected_labels(), $(".trello-card-position:visible input").is(":checked"), blob(save_canvas()));
          }
        });
      });
    };
